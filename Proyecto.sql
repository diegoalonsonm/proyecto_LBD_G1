...
CREATE TABLE FIDE_USUARIOS_TB (
    ...
    CONSTRAINT fk_hoteles_pais FOREIGN KEY (id_pais) 
    REFERENCES FIDE_PAIS_TB(id_pais),
    CONSTRAINT fk_hoteles_provincia FOREIGN KEY (id_provincia) 
    REFERENCES FIDE_PROVINCIA_TB(id_provincia),
    CONSTRAINT fk_hoteles_canton FOREIGN KEY (id_canton) 
    REFERENCES FIDE_CANTON_TB(id_canton),
    CONSTRAINT fk_hoteles_distrito FOREIGN KEY (id_distrito) 
...
CREATE TABLE FIDE_HOTELES_TB (
    ...
    id_distrito INT NOT NULL,
    telefono VARCHAR2(20) NOT NULL,
    CONSTRAINT fk_hotelesTB_pais FOREIGN KEY (id_pais) 
    REFERENCES FIDE_PAIS_TB(id_pais),
    CONSTRAINT fk_hotelesTB_provincia FOREIGN KEY (id_provincia) 
    REFERENCES FIDE_PROVINCIA_TB(id_provincia),
    CONSTRAINT fk_hotelesTB_canton FOREIGN KEY (id_canton) 
    REFERENCES FIDE_CANTON_TB(id_canton),
    CONSTRAINT fk_hotelesTB_distrito FOREIGN KEY (id_distrito) 
    REFERENCES FIDE_DISTRITO_TB(id_distrito),
    CONSTRAINT fk_hotelesTB_estados FOREIGN KEY (id_estado) 
    REFERENCES FIDE_ESTADOS_TB(id_estado)
);
